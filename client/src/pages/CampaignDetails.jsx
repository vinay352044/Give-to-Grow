...
const CampaignDetails = () => {
  ...
  const remaningDays = daysLeft(state.deadline);
              ...
              <div className='mt-[60px] flex lg:flex-row flex-col gap-5'>
                <div className='flex-[2] flex flex-col gap-[40px]'>
                  ...
                  <div>
                    ...
                    <p className='mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]'>10 campaign</p>
                  </div>
                  </div>
                  </div>
                    ...
                    <div className='mt-[20px] flex flex-col gap-4'>
                      {donators.length > 0 ? donators.map((item,index) => (
                        ...
                        className='flex justify-between items-center gap-4'>
                          <p className='font-epilogue fonat-normal text-[16px] text-[#b2b3bd] leading-[26px] break-11'>
